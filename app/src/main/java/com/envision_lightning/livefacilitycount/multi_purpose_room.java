...
public class multi_purpose_room extends AppCompatActivity {

    private static TextView multiTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_multi_purpose_room);

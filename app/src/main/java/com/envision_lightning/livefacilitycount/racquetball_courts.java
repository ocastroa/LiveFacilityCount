...
public class racquetball_courts extends AppCompatActivity {

    private static TextView racquetballTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_racquetball_courts);
    ...
    public void chooseData(){
        retrieve = mydb.retrieveData(6);
        racquetballTextView = (TextView) findViewById(R.id.racquetballTextView);

            extract = retrieve.getString(2);

        if(extract.equals("CLOSED")){
            racquetballTextView.setText("CLOSED");
                }
        else {
            racquetballTextView.setText(extract + " /25");
        }
    }

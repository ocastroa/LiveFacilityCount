...
public class wellness_second_floor extends AppCompatActivity {

    private static TextView WellnessSecondTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wellness_second_floor);
    ...
    public void chooseData(){
        retrieve = mydb.retrieveData(9);
        WellnessSecondTextView = (TextView) findViewById(R.id.WellnessSecondTextView);

        extract = retrieve.getString(2);
        if(extract.equals("CLOSED")){
            WellnessSecondTextView.setText("CLOSED");
        }
        else {
            WellnessSecondTextView.setText(extract + " /140");
        }
    }
